...
export type ZBioLockErrorCode = 'BIOMETRIC_NOT_AVAILABLE' | 'BIOMETRIC_NOT_ENROLLED' | 'AUTHENTICATION_FAILED' | 'AUTHENTICATION_CANCELED' | 'AUTHENTICATION_LOCKED' | 'DEVICE_NOT_SUPPORTED' | 'TOKEN_NOT_FOUND' | 'INVALID_ARGUMENT' | 'UNKNOWN_ERROR';
